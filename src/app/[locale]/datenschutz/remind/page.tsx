...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title: t("privacy_product_title", { product: "SerahrRemind" }), alternates: getAlternates("/datenschutz/remind") };
}

export default async function DatenschutzRemindPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
